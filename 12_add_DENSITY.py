...
outFile = open("12_add_DENSITY_OUTPUT.txt", "w")
...
for fc in inventory_data(searchpath, "FeatureClass"):
    ...
    arcpy.AddField_management(fc, "SUMDENSITY", "DOUBLE")
    arcpy.AddField_management(fc, "CARRVOL_ME", "DOUBLE")
    outFile.write(line + "\tAdded DENSITY, SUMDENSITY, and CARRVOL_ME...\n")
    print line + "\tAdded DENSITY, SUMDENSITY, and CARRVOL_ME..."   
    
    arcpy.CalculateField_management(fc, "DENSITY", "[COVERCALC]* [SQ_METERS]")
    outFile.write(line + "\tCalculated DENSITY...\n")
    print line + "\tCalculated DENSITY..."   
